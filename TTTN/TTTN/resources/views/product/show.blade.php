...
<p>Sản phẩm chính hãng 100%.
        ...
        <button class="bi bi-cart " style="float: left; margin-left: 10px; border:none; height: 40px; width: 200px; background-color: #ECB159; color: white; font-size: 20px" name="muahang">
