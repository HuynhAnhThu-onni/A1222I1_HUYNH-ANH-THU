...
<div style="padding: 20px; width: 100%; border: 1px solid #777777">
    ...
    <a>Home / </a><a style="color:#ECB159">Search</a>
</div>
...
<div style="width:100%;float: left; padding: 10px 20px; margin-top: 30px; border-left: 1px solid #777777">
    @foreach ($listsp as  $all_product)
        <div class="card" style="width: 250px;height:320px;  margin: 0 0 40px 40px; float: left">
            ...
            <div class="card-body">
                <a href="{{url('/shop/show', $all_product->code)}}" style = "text-decoration: none; color: black; margin-left: 70px"><h5 style = "text-align: center" class="card-title">{{  $all_product->name }}</h5></a>
