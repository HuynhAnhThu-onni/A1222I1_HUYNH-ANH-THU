...
<div style="padding: 20px; width: 100%; border: 1px solid #777777">
    ...
    <a>Home / </a><a style="color:#ECB159">Cart</a>
</div>
...
<div class="card" style="width: 18rem; margin-left: 100px; float: left; margin-top: 50px; width: 280px; height: auto">                                 
    <div class="card-body">
        ...
        @csrf
            ...
            <button type="submit" class="btn btn-success" style="border: none; background-color: #ECB159; width: 250px; margin-left: 0px; float: left; margin-top: 25px">Checkout</button>
        </form>
    </div>
</div>
