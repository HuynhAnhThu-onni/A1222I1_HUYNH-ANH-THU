...
<div class="home_content">
    ...
    @csrf
        ...
        <div class="btn_content" style="margin-left: -400px; margin-top: 50px">
            <button type="submit" class="btn btn-success" style="border: none; background-color: #ECB159; width: 170px; margin-left: 500px; float: left; margin-top: 25px">Create</button>
            <a style="border: none; background-color: white; width: 170px; color: #ECB159; border: 1.5px solid #ECB159; margin-top: 25px; margin-left: 20px" class="btn btn-primary" href="{{url('/admin')}}" role="button">Back</a>
        </div>
    </form>
</div>
