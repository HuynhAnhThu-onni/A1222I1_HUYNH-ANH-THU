...
<form style="width: 70%; margin-left: 400px; margin-top: 50px" action = "/profile/update/{{ session('user')->code }}" method="post" class="row g-3">
    ...
    <div class="submit_btn" style="margin-left: 100px">
        <button type="submit" class="btn btn-success" style="border: none; background-color: #ECB159; width: 170px;margin-top: 25px;">Update</button>
        <a style="border: none; background-color: white; width: 170px; color: #ECB159; border: 1.5px solid #ECB159; margin-top: 25px; margin-left: 40px" class="btn btn-primary" href="{{url('/profile', session('user')->code)}}" role="button">Back</a>
    </div>
</form>
